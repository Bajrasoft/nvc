        ...
        private void InsertApplication()
        {
            ...
            using (OracleConnection connection = new OracleConnection())
            {
                ...
                foreach (Dictionary<string, string> dictApplication in lstApplications)
                {
                    ...
                    pFirstTrainDate.Value = dictApplication.ContainsKey("FCD") ? dictApplication["FCD"] : ""; 
                    ...
                    pFirstTrainPlace.Value =dictApplication.ContainsKey("FCL") ? dictApplication["FCL"]:"";
                    ...
                    pFirstCourseTeacher.Value = dictApplication.ContainsKey("FCL") ? dictApplication["FCL"] : "";
                    ...
                    pLastTrainDate.Value = dictApplication.ContainsKey("LCD") ? dictApplication["LCD"] : "";
                    ...
                    pLastTrainPlace.Value = dictApplication.ContainsKey("LCL") ? dictApplication["LCL"] : ""; 
                    ...
                    pLastCourseTeacher.Value = dictApplication.ContainsKey("LCT") ? dictApplication["LCT"] : "";


                    OracleParameter pNoOf10Days = new OracleParameter();
                    pNoOf10Days.OracleDbType = OracleDbType.NVarchar2;
                    pNoOf10Days.ParameterName = "pNoOf10Days";
                    pNoOf10Days.Value = dictApplication.ContainsKey("SFT") ? dictApplication["SFT"] : "";

                    //
                    OracleParameter pNoOfService = new OracleParameter();
                    pNoOfService.OracleDbType = OracleDbType.NVarchar2;
                    pNoOfService.ParameterName = "pNoOfService";
                    pNoOfService.Value = dictApplication.ContainsKey("RFT") ? dictApplication["RFT"] : "";

                    //OracleParameter pAppXML = new OracleParameter();
                    //pAppXML.OracleDbType = OracleDbType.NVarchar2;
                    //pAppXML.ParameterName = "pAppXML";
                    //pAppXML.Value = lstAppXML[appCount];
                    ...
                    command.Parameters.Add(pFirstTrainPlace);
                    command.Parameters.Add(pLastTrainDate);
                    command.Parameters.Add(pLastTrainPlace);
                    command.Parameters.Add(pFirstCourseTeacher);
                    command.Parameters.Add(pLastCourseTeacher);

                    command.Parameters.Add(pNoOf10Days);
                    command.Parameters.Add(pNoOfService);
                ...
                if (email.From.Email == "pforms-application@registrar.dhamma.org")
                {
                    if (email.Attachments.Count > 0)
                    {
                        foreach (MimePart attachment in email.Attachments)
                        {
                            //attachment.
                            //  attachment.TextContent
//attachment.StoreToFile(Server.MapPath(".") + "/Applications/"+attachment.ContentName);
                            xmlString = attachment.TextContent;
                            lstAppXML.Add(xmlString);
        ...
        List<string> lstAppXML = new List<string>();
